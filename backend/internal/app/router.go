	...
	r.Route("/api", func(api chi.Router) {
		...
		api.Route("/admin", func(adminRouter chi.Router) {
			...
			adminRouter.Group(func(protected chi.Router) {
				...
				protected.Get("/ai-routing/scenes", adminHandler.ListAIRoutingScenes)
				...
				protected.Post("/ai-routing/alerts/{providerId}/retest", adminHandler.RetestAIRoutingAlert)
				protected.Post("/ai-routing/alerts/{providerId}/archive", adminHandler.ArchiveAIRoutingAlert)
				protected.Post("/ai-routing/alerts/{providerId}/mute", adminHandler.MuteAIRoutingAlert)
				protected.Post("/ai-routing/alerts/{providerId}/unmute", adminHandler.UnmuteAIRoutingAlert)
		...
		api.Get("/public/app-config", appSettingsHandler.GetPublicAppConfig)
