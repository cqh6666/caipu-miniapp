...
- 修改时间：2026-04-08 12:21 CST
- 变更背景：上一轮虽然已经修掉分享图重叠和信息过密问题，但真机聊天截图看起来仍偏功能卡片，装饰元素、CTA 和邀请码条都略重，整体气质还不够克制高级
- 核心改动：后端动态分享图继续改成更接近邀请函的极简结构，图内取消邀请人头像、能力标签和邀请码展示，把视觉重点重新聚焦到厨房名、轻量邀请语、加入提示和有效期；前端分享标题进一步缩短，降低厨房名较长时在微信聊天卡片里折成两行的概率
